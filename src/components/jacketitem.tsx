      ...
      <div className="2ndmain flex flex-row px-16 pt-2 pb-6 gap-4">
        <div className="col1 w-[320px]">
          <div className="bigpic">
            <div className="pichere w-[320px] h-[320px] bg-orange-300">
              <img src="https://th.bing.com/th/id/OIP.b2q8IdtkS-VolI25I8f1SQHaHa?rs=1&pid=ImgDetMain//" alt="Jacket" className="w-[320px] h-[320px]" />
            </div>
          </div>
        ...
        <div className="col2 flex flex-col w-[500px]">
          <div className="statement text-[20px] font-semibold mx-2 mb-2">
            <span>
              Stylish Winter Jacket with Hood
              <br />
          ...
          <div className="ratenbrand mx-2 mb-2">
            ...
            <div className="rating text-[13px] mb-4">
              ...
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">1500 ratings</span>
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">200 unanswered invites</span>
            </div>
            <div className="brand text-[13px] mb-3">
              ...
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 mb-2 hover:cursor-pointer hover:underline">More jackets from Fashion Brand</span>
            </div>
          </div>
          ...
          <div className="colnquant mx-2 mb-3">
            ...
            <div className="flex flex-row justify-center mb-2">
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="jacket1.webp" alt="Jacket 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="jacket2.jpg" alt="Jacket 2" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="jacket3.png" alt="Jacket 3" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="jacket1.webp" alt="Jacket 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="jacket2.jpg" alt="Jacket 2" /></div>
            </div>
