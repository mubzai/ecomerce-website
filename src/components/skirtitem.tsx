        ...
        <div className="col1 w-[320px]">
          <div className="bigpic">
            <div className="pichere w-[320px] h-[320px] bg-orange-300">
              <img src="https://th.bing.com/th/id/OIP.5OMlkmi1iP3D85j1jMu1rgHaJQ?w=1500&h=1875&rs=1&pid=ImgDetMain" alt="Skirt" className="w-[320px] h-[320px]" />
            </div>
          </div>
        ...
        <div className="col2 flex flex-col w-[500px]">
          ...
          <div className="ratenbrand mx-2 mb-2">
            ...
            <div className="rating text-[13px] mb-4">
              ...
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">1200 ratings</span>
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">100 unanswered invites</span>
            </div>
            <div className="brand text-[13px] mb-3">
              <span className="text-gray-400 mr-2">Brand</span>
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">Fashion Brand</span>
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 mb-2 hover:cursor-pointer hover:underline">More skirts from Fashion Brand</span>
            </div>
          </div>
          ...
          <div className="colnquant mx-2 mb-3">
            ...
            <div className="flex flex-row justify-center mb-2">
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="skirt1.webp" alt="Skirt 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="skirt2.jpg" alt="Skirt 2" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="skirt3.png" alt="Skirt 3" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="skirt1.webp" alt="Skirt 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="skirt2.jpg" alt="Skirt 2" /></div>
            </div>
          ...
          <div className="part2 bg-gray-50">
            ...
            <div className="2nd flex flex-row">
              <div className="flex flex-col pl-2 pr-5 border-[1px] border-gray-150">
                ...
                <span className="text-[24px] mt-3">85%</span>
              </div>
