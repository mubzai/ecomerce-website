        ...
        <div className="col1 w-[320px]">
          <div className="bigpic">
            <div className="pichere w-[320px] h-[320px] bg-orange-300">
              <img src="https://th.bing.com/th/id/OIP.WQHte1IS9qpmeZS3VvjpnwHaHa?rs=1&pid=ImgDetMain" alt="Party Wear" className="w-[320px] h-[320px]" />
            </div>
          </div>
        ...
        <div className="col2 flex flex-col w-[500px]">
          ...
          <div className="ratenbrand mx-2 mb-2">
            ...
            <div className="brand text-[13px] mb-3">
              ...
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">Glamour Brand</span>
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 mb-2 hover:cursor-pointer hover:underline">More dresses from Glamour Brand</span>
            </div>
          </div>
          <div className="orangstrip bg-[#E8532B] flex justify-end py-3 mx-2 mb-3">
            <div className="LINES text-white font-semibold pr-3">
              Check Out the Party Season Deals
              <br />
              Shop Now!
            </div>
          ...
          <div className="pricenother flex flex-col mx-2 mb-3">
            ...
            <div>
              ...
              <span className="text-[14px]">Upto 12 months, as low as Rs.208 per month.</span>
            </div>
          </div>
          <div className="colnquant mx-2 mb-3">
            ...
            <div className="flex flex-row justify-center mb-2">
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="partywear1.webp" alt="Party Wear 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="partywear2.jpg" alt="Party Wear 2" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="partywear3.png" alt="Party Wear 3" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="partywear1.webp" alt="Party Wear 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="partywear2.jpg" alt="Party Wear 2" /></div>
            </div>
          ...
          <div className="part2 bg-gray-50">
            <div className="1st flex flex-row px-5">
              <div className="flex flex-col">
                ...
                <span>Glamour Store (Lahore)</span>
              </div>
            ...
            <div className="2nd flex flex-row">
              ...
              <div className="flex flex-col pl-2 pr-5 border-[1px] border-l-0 border-gray-150">
                <span className="text-[14px] text-gray-700">ship on time<br />99%</span>
