...
export const GymWearItem = () => {
  return (
    <div className="main">
      <div className="2ndmain flex flex-row px-16 pt-2 pb-6 gap-4">
        <div className="col1 w-[320px]">
          <div className="bigpic">
            <div className="pichere w-[320px] h-[320px] bg-orange-300">
              <img src="https://th.bing.com/th/id/OIP.26xhsEkIPSmTbIvOLTkCegAAAA?rs=1&pid=ImgDetMain" alt="Gym Wear" className="w-[320px] h-[320px]" />
            </div>
          </div>
        ...
        <div className="col2 flex flex-col w-[500px]">
          <div className="statement text-[20px] font-semibold mx-2 mb-2">
            <span>
              High-Performance Gym Wear
              <br />
              Breathable and Flexible Fabric
              <br />
              Ideal for Workouts and Training
              <br />
          ...
          <div className="ratenbrand mx-2 mb-2">
            ...
            <div className="rating text-[13px] mb-4">
              ...
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">1800 ratings</span>
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">250 unanswered invites</span>
            </div>
            <div className="brand text-[13px] mb-3">
              <span className="text-gray-400 mr-2">Brand</span>
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">Active Wear</span>
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 mb-2 hover:cursor-pointer hover:underline">More gym wear from Active Wear</span>
            </div>
          </div>
          <div className="orangstrip bg-[#E8532B] flex justify-end py-3 mx-2 mb-3">
            <div className="LINES text-white font-semibold pr-3">
              Check Out the Fitness Sale Deals
              <br />
              Shop Now!
            </div>
          ...
          <div className="pricenother flex flex-col mx-2 mb-3">
            ...
            <div>
              ...
              <span className="text-[14px]">Upto 12 months, as low as Rs.100 per month.</span>
            </div>
          </div>
          <div className="colnquant mx-2 mb-3">
            ...
            <div className="flex flex-row justify-center mb-2">
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="gymwear1.webp" alt="Gym Wear 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="gymwear2.jpg" alt="Gym Wear 2" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="gymwear3.png" alt="Gym Wear 3" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="gymwear1.webp" alt="Gym Wear 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="gymwear2.jpg" alt="Gym Wear 2" /></div>
            </div>
        ...
        <div className="col3 flex flex-col gap-3">
          <div className="part1 py-4 bg-gray-50">
            <div className="flex justify-between py-2 px-5">
              ...
              <div className=""><TbTruckDelivery className="text-gray-700" /></div>
            </div>
            <div className="flex flex-row py-2 gap-5 border-b-[1px] border-gray-150 px-5">
              <div className="flex flex-col justify-center align-middle"><FaMapMarkerAlt className="text-gray-600" /></div>
            ...
            <div className="flex flex-row py-2 gap-5 px-5 border-b-[1px] border-gray-150">
              <div className="flex flex-col justify-center align-middle"><TbCashRegister className="text-gray-500" /></div>
            ...
            <div className="flex justify-between py-3 gap-5 px-5">
              ...
              <div><GiReturnArrow className="text-gray-500" /></div>
            </div>
            <div className="flex flex-row py-2 gap-5 px-5">
              <div className="flex flex-col justify-center align-middle"><PiKeyReturnFill className="text-gray-500" /></div>
              <div className="">14 Days easy Return</div>
            </div>

            <div className="flex flex-row py-2 gap-5 px-5 border-b-[1px] border-gray-150">
              <div className="flex flex-col justify-center align-middle"><PiShieldWarningLight className="text-gray-500" /></div>
              <div className="">Warranty Not Available</div>
            </div>

            <div className="flex flex-row py-2 px-5 gap-2">
              <div className="flex flex-col justify-center align-middle text-center">
                <div className="w-[100px] h-[100px]"><img src="qrcode.jpeg" alt="QR Code" /></div>
                <div className="text-[12px]">scan with mobile</div>
              </div>
              <div className="h-[100px] w-[150px] shadow-md shadow-gray-400 rounded-md bg-white">
                <div className="w-[44px] h-[44px] pl-2 pt-2"><img src="darazii.png" alt="App Logo" /></div>
          ...
          <div className="part2 bg-gray-50">
            ...
            <div className="2nd flex flex-row">
              <div className="flex flex-col pl-2 pr-5 border-[1px] border-gray-150">
                ...
                <span className="text-[24px] mt-3">90%</span>
              </div>
              <div className="flex flex-col pl-2 pr-5 border-[1px] border-l-0 border-gray-150">
                <span className="text-[14px] text-gray-700">ship on time<br />98%</span>
                <span className="text-[24px] mt-3">95%</span>
              </div>
              <div className="flex flex-col pl-2 pr-5 border-[1px] border-l-0 border-gray-150">
            ...
            <div className="3rd py-2 text-center text-[14px] text-blue-700">GO TO STORE</div>
          </div>
        </div>
      </div>
    </div>
