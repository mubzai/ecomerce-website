        ...
        <div className="col1 w-[320px]">
          <div className="bigpic">
            <div className="pichere w-[320px] h-[320px] bg-orange-300">
              <img src="https://th.bing.com/th/id/OIP.xZGkTQ3grFSh1zI1z9WTewHaJn?rs=1&pid=ImgDetMain" alt="Shirt" className="w-[320px] h-[320px]" />
            </div>
          </div>
        ...
        <div className="col2 flex flex-col w-[500px]">
          ...
          <div className="ratenbrand mx-2 mb-2">
            ...
            <div className="brand text-[13px] mb-3">
              ...
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 mb-2 hover:cursor-pointer hover:underline">More shirts from Fashion Brand</span>
            </div>
          </div>
          <div className="orangstrip bg-[#E8532B] flex justify-end py-3 mx-2 mb-3">
            <div className="LINES text-white font-semibold pr-3">
              Check Out the Autumn Sale Deals
              <br />
              Shop Now!
            </div>
          ...
          <div className="pricenother flex flex-col mx-2 mb-3">
            ...
            <div>
              ...
              <span className="text-[14px]">Upto 12 months, as low as Rs.83 per month.</span>
            </div>
          </div>
          <div className="colnquant mx-2 mb-3">
            ...
            <div className="flex flex-row justify-center mb-2">
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="shirt1.webp" alt="Shirt 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="shirt2.jpg" alt="Shirt 2" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="shirt3.png" alt="Shirt 3" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="shirt1.webp" alt="Shirt 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="shirt2.jpg" alt="Shirt 2" /></div>
            </div>
