        ...
        <div className="col1 w-[320px]">
          <div className="bigpic">
            <div className="pichere w-[320px] h-[320px] bg-orange-300">
              <img src="https://th.bing.com/th/id/R.ff29f98265bbf440c19bbc389f2f1637?rik=tif0buyt29rbxw&pid=ImgRaw&r=0" alt="Sunglasses" className="w-[320px] h-[320px]" />
            </div>
          </div>
        ...
        <div className="col2 flex flex-col w-[500px]">
          ...
          <div className="ratenbrand mx-2 mb-2">
            ...
            <div className="rating text-[13px] mb-4">
              ...
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">800 ratings</span>
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">50 unanswered invites</span>
            </div>
            <div className="brand text-[13px] mb-3">
              <span className="text-gray-400 mr-2">Brand</span>
              <span className="text-blue-600 mr-2 hover:cursor-pointer hover:underline">Sunshine Optics</span>
              <span className="mr-2">|</span>
              <span className="text-blue-600 mr-2 mb-2 hover:cursor-pointer hover:underline">More sunglasses from Sunshine Optics</span>
            </div>
          </div>
          <div className="orangstrip bg-[#E8532B] flex justify-end py-3 mx-2 mb-3">
            <div className="LINES text-white font-semibold pr-3">
              Check Out the Summer Sale Deals
              <br />
              Shop Now!
            </div>
          ...
          <div className="pricenother flex flex-col mx-2 mb-3">
            ...
            <div>
              ...
              <span className="text-[14px]">Upto 12 months, as low as Rs.125 per month.</span>
            </div>
          </div>
          <div className="colnquant mx-2 mb-3">
            ...
            <div className="flex flex-row justify-center mb-2">
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="sunglasses1.webp" alt="Sunglasses 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="sunglasses2.jpg" alt="Sunglasses 2" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="sunglasses3.png" alt="Sunglasses 3" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 mr-2 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="sunglasses1.webp" alt="Sunglasses 1" /></div>
              <div className="w-[32px] h-[32px] bg-yellow-300 hover:border-[1px] hover:border-orange-600 hover:cursor-pointer"><img src="sunglasses2.jpg" alt="Sunglasses 2" /></div>
            </div>
          ...
          <div className="part2 bg-gray-50">
            <div className="1st flex flex-row px-5">
              <div className="flex flex-col">
                ...
                <span>Sunshine Store (Lahore)</span>
              </div>
            ...
            <div className="2nd flex flex-row">
              ...
              <div className="flex flex-col pl-2 pr-5 border-[1px] border-l-0 border-gray-150">
                <span className="text-[14px] text-gray-700">ship on time<br />95%</span>
                <span className="text-[24px] mt-3">92%</span>
              </div>
              <div className="flex flex-col pl-2 pr-5 border-[1px] border-l-0 border-gray-150">
